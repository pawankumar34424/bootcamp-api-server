...
//        e.g https://github.com/pawankumar34424/event-api-server-demo.git might become https://github.com/MyName/external.git
...
//      https://github.com/pawankumar34424/event-api-server-demo.git
//      pawankumar34424
//      api-server-image
//      cnd-events-cluster 
//      us-east-1  
...
pipeline {
   ...
   environment {
        ...
        imageName = 'pawankumar34424/api-server-image'
        dockerImage = ''
        }
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/pawankumar34424/event-api-server-demo.git'
        ...
        stage('Building image') {
         ...
         stage('update k8s') {
            ...
            steps {
                echo 'Set the image'
                     sh "kubectl -n user09 set image deployment/demo-api demo-api=${env.imageName}:${env.BUILD_NUMBER} --kubeconfig=${WORKSPACE}/.kube/config"
            }
        }     
